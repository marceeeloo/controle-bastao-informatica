                ...
                with col_a2:
                    ...
                    if st.button("📥 Gerar e Abrir PDF", use_container_width=True):
                        try:
                            ...
                            st.info("💡 Instale o reportlab: python -m pip install reportlab")
